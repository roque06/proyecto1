...
public class fmpagos extends javax.swing.JInternalFrame {
    ...
    void cargarcodigo() {
        ...
        String num = "";
        String c = "";
        String SQL = "select max(numero_comprobante) from pago ";
        try {
            ...
            if (c == null) {
                txtnumero_comprobante.setText("CD0001");
            } else {
                char r1 = c.charAt(2);
                char r2 = c.charAt(3);
                char r3 = c.charAt(4);
                ...
                gen.generar(j);
                txtnumero_comprobante.setText("CD" + gen.serie());
    ...
    private void initComponents() {
        ...
        btnimpimir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/reportes.jpg"))); // NOI18N
