 ...
 */
public class fmvista extends javax.swing.JFrame {

    /**
     * Creates new form fmvista
     */
    public fmvista() {
        initComponents();
        mostrar("");
  ...
  void mostrar(String buscar) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fmvista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
