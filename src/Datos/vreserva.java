...
public class vreserva {
    ...
    public vreserva(int idreserva, int idhabitacion, int idcliente, int idtrabajador, String tiporeserva, Date fecha_reserva, Date fecha_ingreso, Date fecha_salida, Double costo_alojamiento, String estado) {
